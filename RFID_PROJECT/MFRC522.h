...
#define _chipSelectPin PB12
#define _resetPowerDownPin PB11
#define byte uint8_t
...
static const byte MFRC522_firmware_referenceV0_0[] PROGMEM = {
...
static const byte MFRC522_firmware_referenceV1_0[] PROGMEM = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
static const byte MFRC522_firmware_referenceV2_0[] PROGMEM = {
...
static const byte FM17522_firmware_reference[] PROGMEM = {
...
// MFRC522 RxGain[2:0] masks, defines the receiver's signal voltage gain factor (on the PCD).
	...
	void PCD_WriteRegister_count(PCD_Register reg, byte count, byte *values);
	byte PCD_ReadRegister(PCD_Register reg);
	void PCD_ReadRegister_count(PCD_Register reg, byte count, byte *values, byte rxAlign);
